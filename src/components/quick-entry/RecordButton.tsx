...
export default function RecordButton({
  ...
  const getButtonText = () => {
    switch (entryType) {
      case "Sale":
        return isCredit ? "Record Credit Sale" : "Record Sales";
      case "Purchase":
        return isCredit ? "Record Credit Purchase" : "Record Purchase";
      case "Payment In":
        return "Record Payment In";
      case "Payment Out":
        return "Record Payment Out";
      case "Expense":
